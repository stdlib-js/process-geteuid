...
```javascript
import geteuid from 'https://cdn.jsdelivr.net/gh/stdlib-js/process-geteuid@v0.2.2-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/process-geteuid/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/process-geteuid/actions/workflows/test.yml?query=branch:v0.2.2
