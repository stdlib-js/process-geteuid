...
```javascript
geteuid = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/process-geteuid@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/process-geteuid@umd/bundle.js"></script>
```
